...
class _NotificarScreenState extends State<NotificarScreen> {
  ...
  List<dynamic> get _catalogoActual =>
      _tipoActual == 'merito' ? _catalogoMeritos : _catalogoDemeritos;
  ...
  void _buscarActividades(String query) {
    ...
    final filtrados = catalogo.where((item) {
      ...
      final coincideCat =
          _categoriaFiltro == null || item['categoria'] == _categoriaFiltro;
  ...
  List<int> _parsearRango(dynamic str) {
    ...
    return [
      ...
      int.tryParse(parts.length > 1 ? parts[1] : parts[0]) ?? 1
    ];
  }
  ...
  void _agregarActividad() {
    ...
    setState(() {
      _actividadesAgregadas.add({
        ...
        'nombre': _tipoActual == 'merito'
            ? _actividadSeleccionada['causa']
            : _actividadSeleccionada['falta'],
        'cantidad': cantidad,
        'valor10mo': v10,
        'valor11_12': v11,
      });
    ...
    if (response['success'] == true) {
      ...
      if (_usandoCuentaTemporal) {
        setState(() {
          ...
          _idStar = DatabaseService.usuario?.id ?? 0;
          _tipoNotificador = 'cuenta';
          _cargoNotificador = DatabaseService.usuario?.cargo ?? '';
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            ...
            style: TextStyle(fontSize: 22, fontWeight: FontWeight.w700, color: Color(0xFF1E3C72)),
          ),
          const SizedBox(height: 20),
          Text(
          ...
          Wrap(
            spacing: 8,
            children: _destinatarios
                .map((d) => Chip(
                      label: Text('${d['nombre']} (${d['grado']})'),
          ...
          Text(
            'Actividades (${_actividadesAgregadas.length})',
            style: const TextStyle(fontWeight: FontWeight.w600, color: Color(0xFF64748B)),
          ),
          ...(_actividadesAgregadas.map((a) {
            ...
            return Container(
              ...
              decoration: BoxDecoration(
                color: a['tipo'] == 'merito' ? const Color(0xFFD1FAE5) : const Color(0xFFFEE2E2),
                borderRadius: BorderRadius.circular(12),
              ),
              child: Text(
                '${a['nombre']} - $valor',
                style: TextStyle(
                  color: a['tipo'] == 'merito' ? const Color(0xFF065F46) : const Color(0xFF991B1B),
                ),
              ),
            );
          })),
                      ...
                      children: [
                        ...
                        if (_destinatarios.isEmpty)
                          Container(
                            ...
                            child: const Center(
                              child: Text('No hay destinatarios agregados', style: TextStyle(color: Color(0xFF888888))),
                            ),
                          )
                        else
                          Wrap(
                            ...
                            children: _destinatarios.asMap().entries.map((entry) {
                              final d = entry.value;
                              return Chip(
                                label: Text('${d['nombre']} (${d['ci']}) - ${d['grado']}',
                      ...
                      children: [
                        ...
                        if (_actividadesAgregadas.isEmpty)
                          Container(
                            ...
                            child: const Center(
                              child: Text('No hay actividades agregadas', style: TextStyle(color: Color(0xFF888888))),
                            ),
                          )
                        else
                          ...(_actividadesAgregadas.asMap().entries.map((entry) {
                            ...
                            return Container(
                              ...
                              child: Row(children: [
                                ...
                                Text(
                                  '${act['tipo'] == 'merito' ? "+" : "-"}${act['cantidad']}',
                                  style: TextStyle(fontWeight: FontWeight.w700, fontSize: 18, color: color),
                                ),
                                const SizedBox(width: 10),
                                GestureDetector(
                                  onTap: () => setState(() => _actividadesAgregadas.removeAt(entry.key)),
                          ...
                          Container(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                final valor = _tipoActual == 'merito'
                                    ? '+${item['meritos']}'
                                    : '${item['demeritos_10mo']}/${item['demeritos_11_12']}';
                                return ListTile(
                                  title: Text(nombre),
                                  ...
                                  trailing: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: _tipoActual == 'merito' ? const Color(0xFFD1FAE5) : const Color(0xFFFEE2E2),
                                    ...
                                    child: Text(
                                      ...
                                      style: TextStyle(
                                        ...
                                        color: _tipoActual == 'merito' ? const Color(0xFF065F46) : const Color(0xFF991B1B),
                                      ),
                                    ),
                                  ),
                                  onTap: () => _seleccionarActividad(item),
                                );
                              },
                            ),
                          ),
                        ...
                        Expanded(
                          child: GestureDetector(
                            ...
                            child: Container(
                              padding: const EdgeInsets.symmetric(vertical: 14),
                              decoration: BoxDecoration(
                                color: _tipoActual == 'merito' ? const Color(0xFF10B981) : Colors.white,
                                borderRadius: BorderRadius.circular(14),
                                border: Border.all(color: _tipoActual == 'merito' ? const Color(0xFF10B981) : const Color(0xFFE0E0E0), width: 2),
                              ),
                              child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                Icon(Icons.emoji_events, color: _tipoActual == 'merito' ? Colors.white : const Color(0xFF10B981)),
                                const SizedBox(width: 8),
                                Text('Mérito', style: TextStyle(fontWeight: FontWeight.w600, color: _tipoActual == 'merito' ? Colors.white : const Color(0xFF10B981))),
                              ]),
                            ),
                          ),
                        ),
                        ...
                        Expanded(
                          child: GestureDetector(
                            ...
                            child: Container(
                              padding: const EdgeInsets.symmetric(vertical: 14),
                              decoration: BoxDecoration(
                                color: _tipoActual == 'demerito' ? const Color(0xFFEF4444) : Colors.white,
                                borderRadius: BorderRadius.circular(14),
                                border: Border.all(color: _tipoActual == 'demerito' ? const Color(0xFFEF4444) : const Color(0xFFE0E0E0), width: 2),
                              ),
                              child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                Icon(Icons.warning_amber, color: _tipoActual == 'demerito' ? Colors.white : const Color(0xFFEF4444)),
                                const SizedBox(width: 8),
                                Text('Demérito', style: TextStyle(fontWeight: FontWeight.w600, color: _tipoActual == 'demerito' ? Colors.white : const Color(0xFFEF4444))),
                              ]),
                            ),
                          ),
                        ),
                      ...
                      if (_tipoActual == 'demerito' && hay10mo && _actividadSeleccionada != null)
                        Container(
                          ...
                          child: Column(children: [
                            ...
                            Slider(
                              min: _sliderMin10mo.toDouble(),
                              max: _sliderMax10mo.toDouble(),
                              value: _slider10mo,
                              onChanged: (v) => setState(() => _slider10mo = v),
                      ...
                      if (_tipoActual == 'demerito' && hay11_12 && _actividadSeleccionada != null)
                        Container(
                          ...
                          child: Column(children: [
                            ...
                            Slider(
                              min: _sliderMin11_12.toDouble(),
                              max: _sliderMax11_12.toDouble(),
                              value: _slider11_12,
                              onChanged: (v) => setState(() => _slider11_12 = v),
                              activeColor: const Color(0xFFD97706),
                            ),
                        ...
                        Expanded(
                          child: TextField(
                            ...
                            onTap: () async {
                              ...
                              if (date != null) _fechaController.text = date.toString().split(' ')[0];
                            },
                          ),
                        ),
                        const SizedBox(width: 12),
                  ...
                  Container(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Row(children: [
                        ...
                        Expanded(
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            Text(_usandoCuentaTemporal ? 'Cuenta Temporal' : 'Yo (Cuenta actual)',
                        ...
                        TextButton.icon(
                          onPressed: _showDialogCuentaTemporal,
                  ...
                  Container(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      TextField(
                        ...
                        maxLines: 3,
                        decoration: const InputDecoration(hintText: 'Notas adicionales...', border: OutlineInputBorder()),
                      ),
                    ]),
                  ),
                  const SizedBox(height: 20),
