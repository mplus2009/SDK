...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    ...
    if (response['success'] == true) {
      ...
      _showSnackBar(response['message'] ?? 'Error al iniciar sesion', Colors.red);
    }
  }
    ...
    return Scaffold(
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(colors: [Color(0xFF1E3C72), Color(0xFF2A5298)], begin: Alignment.topCenter, end: Alignment.bottomCenter),
        ),
        child: SafeArea(
          child: Center(
            child: SingleChildScrollView(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(color: const Color(0xFFFAFAFA), borderRadius: BorderRadius.circular(30),
                  boxShadow: [BoxShadow(color: Colors.black.withOpacity(0.3), blurRadius: 60, offset: const Offset(0, 30))]),
                ...
                child: Form(
                  ...
                  child: Column(mainAxisSize: MainAxisSize.min, children: [
                    const Column(children: [
                      ...
                      SizedBox(height: 4),
                      Text('Sistema de Gestion Escolar', style: TextStyle(fontSize: 15, color: Color(0xFF666666))),
                    ]),
                    ...
                    Container(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          label: const Text('Escanear QR para Iniciar Sesion', style: TextStyle(fontSize: 16)),
                          style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFF1E3C72), foregroundColor: Colors.white,
                            padding: const EdgeInsets.symmetric(vertical: 16), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(50)),
                            elevation: 8, shadowColor: const Color(0xFF1E3C72).withOpacity(0.3)),
                        ),
                      ),
                    ),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: 'Contrasena', hintText: 'Ingresa tu contrasena',
                        prefixIcon: const Icon(Icons.lock, color: Color(0xFF2A5298)),
                        suffixIcon: IconButton(icon: Icon(_obscurePassword ? Icons.visibility_off : Icons.visibility, color: const Color(0xFF2A5298)),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: _isLoading
                            ...
                            : const Text('Iniciar Sesion', style: TextStyle(fontSize: 18)),
                      ),
                    ),
                    const SizedBox(height: 20),
                    const Text('Ingresa con tu nombre, apellidos y contrasena', textAlign: TextAlign.center,
