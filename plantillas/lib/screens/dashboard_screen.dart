...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Future<void> _cargarDashboard() async {
    ...
    if (response['success'] == true) {
      ...
      setState(() {
        _error = response['message'] ?? 'Error al cargar';
        _isLoading = false;
      });
    }
  }
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: Color(0xFF1E3C72)),
          ),
        ...
        ? const Center(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 15),
                Text('Cargando dashboard...', style: TextStyle(color: Color(0xFF64748B))),
              ],
            ),
          )
        : _error != null
                      ...
                      actions: [
                        ...
                        PopupMenuButton<String>(
                          ...
                          itemBuilder: (context) => [
                            ...
                            const PopupMenuItem(value: 'logout', child: ListTile(leading: Icon(Icons.logout, color: Colors.red), title: Text('Cerrar Sesion', style: TextStyle(color: Colors.red)))),
                          ],
                        ),
                      ],
                    ),
                              ...
                              Container(
                                ...
                                child: const Row(children: [
                                  ...
                                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    ...
                                    Text('Has alcanzado el limite de demeritos.', style: TextStyle(color: Colors.white70, fontSize: 13)),
                                  ])),
                                ]),
                              ),
                              // ============================================
// BUSCADOR (DIRECTIVA, OFICIAL, PROFESOR)
// ============================================
if (['directiva', 'oficial', 'profesor'].contains(_usuario?.cargo) || _usuario?.ocupacion == 'secretaria')
  Container(
                ...
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 10),
                      Row(children: [
                        _buildMiniStat('${est['meritos'] ?? 0}', 'Meritos', const Color(0xFF10B981)),
                        const SizedBox(width: 15),
                        _buildMiniStat('${est['demeritos'] ?? 0}', 'Demeritos', const Color(0xFFEF4444)),
                        const SizedBox(width: 15),
                      ...
                      Row(children: [
                        Expanded(
                          child: ElevatedButton.icon(
                            onPressed: () {
                              Navigator.push(context, MaterialPageRoute(builder: (_) => NotificarScreen(destinatarioPrecargado: est)));
                            },
                              ...
                              if (_usuario?.cargo == 'estudiante') ...[
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Row(children: [
                                        const Icon(Icons.calendar_today, color: Color(0xFF667EEA), size: 22),
                                        const SizedBox(width: 8),
                                        const Text('Esta Semana', style: TextStyle(fontSize: 19, fontWeight: FontWeight.w700, color: Color(0xFF1E3C72))),
                                        const Spacer(),
                                        Text(_dashboardData?['semana_fecha'] ?? '', style: const TextStyle(fontSize: 11, color: Color(0xFF64748B))),
                                      ]),
                                      const SizedBox(height: 16),
                                      if (_dashboardData?['semana_actual'] == null || (_dashboardData!['semana_actual'] as List).isEmpty)
                                        const Center(child: Padding(padding: EdgeInsets.all(20), child: Text('Sin actividades esta semana', style: TextStyle(color: Color(0xFF94A3B8)))))
                                      else
                                        ...(_dashboardData!['semana_actual'] as List).map((act) => _buildActividadItem(act)),
                                    ],
                                  ),
                                ),
                                // SEMANAS ANTERIORES
                                if (_dashboardData?['semanas_anteriores'] != null)
                                  ...(_dashboardData!['semanas_anteriores'] as List).map((act) => _buildActividadItem(act)),
                              ],

                              // ============================================
                              // PANEL PROFESOR/OFICIAL
                              // ============================================
                              if (['profesor', 'oficial'].contains(_usuario?.cargo))
                                Container(
                                  ...
                                  child: Column(children: [
                                    ...
                                    const SizedBox(height: 10),
                                    const Text('Bienvenido al sistema de gestion escolar.', style: TextStyle(color: Color(0xFF64748B))),
                                    const SizedBox(height: 20),
  ...
  Widget _buildActividadItem(dynamic act) {
    ...
    return Container(
      ...
      child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text(act['falta_causa'] ?? 'Sin descripcion', style: const TextStyle(fontWeight: FontWeight.w600, color: Color(0xFF1E293B), fontSize: 15)),
