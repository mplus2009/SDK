      ...
      children: [
        ...
        ...(_actividadesAgregadas.map((a) {
          ...
          if (hayAmbos &&
              ...
              a['valor11_12'] != null) {
            valor =
                '10mo: -${a['valor10mo']} | 11/12: -${a['valor11_12']}';
          }
          return Container(
...
Widget build(BuildContext context) {
  final puedeEnviar =
      _destinatarios.isNotEmpty && _actividadesAgregadas.isNotEmpty;
  final grupos = _obtenerGruposPorGrado();
  final hay10mo = grupos['10mo']!.isNotEmpty;
  final hay11_12 = grupos['11no']!.isNotEmpty;
                    ...
                    children: [
                      ...
                      if (_destinatarios.isEmpty)
                        Container(
                          ...
                          child: const Center(
                            child: Text('No hay destinatarios agregados',
                                style:
                        ...
                        Wrap(
                          ...
                          children: _destinatarios.asMap().entries.map((entry) {
                            ...
                            return Chip(
                              ...
                              onDeleted: () => setState(() =>
                                  _destinatarios.removeAt(entry.key)),
                            );
                          }).toList(),
                        ),
                      const SizedBox(height: 15),
                              ...
                              return ListTile(
                                ...
                                title: Text(
                                    ...
                                    style: const TextStyle(
                                        fontWeight: FontWeight.w600)),
                                subtitle: Text(
                                    'CI: ${est['ci']} | Grado: ${est['grado'] ?? '10mo'}'),
                    ...
                    children: [
                      ...
                      if (_actividadesAgregadas.isEmpty)
                        ...
                        ...(_actividadesAgregadas.asMap().entries.map((entry) {
                          ...
                          final bg = act['tipo'] == 'merito'
                              ? const Color(0xFFD1FAE5)
                              : const Color(0xFFFEE2E2);
                          final color = act['tipo'] == 'merito'
                              ? const Color(0xFF065F46)
                              : const Color(0xFF991B1B);
                          return Container(
                        ...
                        Container(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              final nombre = _tipoActual == 'merito'
                                  ? item['causa']
                                  : item['falta'];
      ...
      children: [
        Row(children: [
          ...
          Expanded(
            child: GestureDetector(
              onTap: () => setState(
                  () => _tipoActual = 'demerito'),
              child: Container(
                padding: const EdgeInsets.symmetric(
                    vertical: 14),
                decoration: BoxDecoration(
                  color: _tipoActual == 'demerito'
          ...
          Container(
            ...
            child: Column(children: [
              ...
              Slider(
                ...
                value: _slider10mo,
                onChanged: (v) =>
                    setState(() => _slider10mo = v),
                activeColor: const Color(0xFFD97706),
              ),
              Text('${_slider10mo.toInt()}',
                  style: const TextStyle(
                      fontSize: 24,
          ...
          Container(
            ...
            child: Column(children: [
              ...
              Slider(
                ...
                value: _slider11_12,
                onChanged: (v) =>
                    setState(() => _slider11_12 = v),
                activeColor: const Color(0xFFD97706),
              ),
              Text('${_slider11_12.toInt()}',
                  style: const TextStyle(
                      fontSize: 24,
                      fontWeight: FontWeight.w800,
                      color: Color(0xFF856404))),
      ...
      children: [
        ...
        Row(children: [
          const Icon(Icons.account_circle,
              size: 42, color: Color(0xFF667EEA)),
          ...
          Expanded(
            child: Column(
                ...
                children: [
                  Text(
                      _usandoCuentaTemporal
                          ? 'Cuenta Temporal'
                          : 'Yo (Cuenta actual)',
                      style: const TextStyle(
                          fontWeight: FontWeight.w700,
                          color: Color(0xFF1E293B))),
                  Text(_notificadorNombre,
                      style: const TextStyle(
                          color: Color(0xFF64748B))),
                  Text(_notificadorCargo,
                      style: const TextStyle(
                          fontSize: 12,
                          color: Color(0xFF64748B))),
                ]),
...
const SizedBox(height: 20),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      onPressed:
                          puedeEnviar ? _mostrarConfirmacion : null,
                      icon: _enviando
                          ? const SizedBox(
                              width: 20,
                              height: 20,
